...
public class UserVO {
	...
	public UserVO(Long userId, String userIdentification, String userName, String userPassword, String userPhone,
			String userNickname, String userEmail, String userAddress, String userBirth, String userGender,
			String userRecommenderId) {
		super();
		this.userId = userId;
