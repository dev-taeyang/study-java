...
////	엔진 상태를 확인 하고
////	시동이 꺼져 있다면, " 시동 켜기" 출력
////	이미 시동이 켜져 있다면, "시동이 이미 켜져 있습니다." 출력
//
//	void engineOn() { // engineState 0 꺼짐 1 켜짐
//
//		for (int i = 0; i < 2; i++) {
//
//			if (engineState == 0) {
...
////엔진 상태를 확인하고
////시동이 켜져 있다면, "시동 끄기" 출력
////이미 시동이 꺼져 있다면, "시동이 이미 꺼져 있습니다." 출력
//
//	void engineOff() { // engineState 0 꺼짐 1 켜짐
//
//		for (int i = 0; i < 2; i++) {
//
//			if (engineState == 0) {
...
//   생성자
   ...
   public SuperCar(String brand, String color, int price) { //브랜드 색상 가격 생성자
      this.brand = brand;
      this.color = color;
      this.price = price;
   }
